            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <!-- /.box-header -->
                        <div class="box-body">
                            {{ Form::open(array('action' => array('ExpenseController@update_routine_expense','method' => 'POST','id' => $expense->id)))}}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="box-body">

                                        <div class="form-group col-md-4">
                                            {{  Form::label('id_transaction', 'Vencimento') }}
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                    <i class="fa fa-globe"></i>
                                                </div>
                                                {{  Form::text('id_transaction', $value = $expense->id ,array('class' => 'form-control pull-right', 'placeholder' => 'Vencimento', "disabled"))}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group date col-md-4">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                {{  Form::text('expire_expense_date', $value = Carbon\Carbon::parse($expense->expire_expense_date)->format('d-m-Y'),array('class' => 'form-control pull-right datepicker', 'placeholder' => 'Vencimento',"disabled"))}}
                                            </div>
                                        </div>
                                        <div class="form-group date col-md-4">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                {{  Form::number('price', $expense->price,array('class' => 'form-control pull-right',"step" => "0.01", 'placeholder' => 'Valor',"disabled",'max' => '1000000'))}}
                                            </div>
                                        </div>
                                        <div class="form-group date col-md-12">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <select name="expense_category_id" class="form-control select2 select2-hidden-accessible" disabled>
                                        ...
                                        <div class="form-group date col-md-12">
                                            ...
                                            {{  Form::textarea('description', $expense->description,array('class' => 'form-control pull-right',    'placeholder' => 'Descrição',"disabled"))}}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{action("ExpenseController@remove_routine_expense", ['id' => $expense->id])}}" class="btn btn-block btn-flat btn-danger">
                                            Remover</a>
                                    </div>
                                </div>
                            </div>
