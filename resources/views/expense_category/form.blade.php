...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                {{Lang::get('expense_category.expense_categories')}}
            </h1>
        </section>
        <!-- Main content -->
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <!-- /.box-header -->
                        <div class="box-body">
                            {{ Form::open(array('action' => array($action,'id' => $expense_category->id)))}}
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    <div class="box-body">
                                        <div class="form-group has-feedback col-sm-12 col-md-6 col-lg-6">
                                            {{  Form::label('name', 'Nome') }}
                                            {{  Form::text('name', $value = $expense_category->name,array('class' => 'form-control', 'placeholder' => 'Nome'))}}
                                        </div>
